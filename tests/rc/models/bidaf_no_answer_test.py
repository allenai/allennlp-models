...
class BidirectionalAttentionFlowNoAnswerTest(ModelTestCase):
    """
    These tests are copied almost-wholesale from the BiDAF tests.
    """

    def setup_method(self):
        super().setup_method()
        self.set_up_model(
            FIXTURES_ROOT / "rc" / "bidaf_no_answer" / "experiment.json",
    ...
    def test_batch_predictions_are_consistent(self):
        ...
        self.instances = reader.read(FIXTURES_ROOT / "rc" / "squad2.json")

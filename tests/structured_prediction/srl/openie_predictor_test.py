...
from allennlp_models.structured_prediction.srl.openie_predictor import (
    sanitize_label,
...
class TestOpenIePredictor(AllenNlpTestCase):
    def test_uses_named_inputs(self):
        ...
        archive = load_archive(FIXTURES_ROOT / "structured_prediction" / "srl" / "serialization" / "model.tar.gz")

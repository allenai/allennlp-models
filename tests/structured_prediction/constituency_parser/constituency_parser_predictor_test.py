...
from allennlp_models.structured_prediction.constituency_parser.constituency_parser_predictor import (
    LINK_TO_LABEL,
    NODE_TYPE_TO_STYLE,
)
...
class TestConstituencyParserPredictor(AllenNlpTestCase):
    def test_uses_named_inputs(self):
        ...
        archive = load_archive(
            FIXTURES_ROOT / "structured_prediction" / "constituency_parser" / "serialization" / "model.tar.gz"
        )

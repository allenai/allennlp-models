...
class TestAllenNlpPretrained(AllenNlpTestCase):
    def test_machine_comprehension(self):
        predictor = pretrained.get_predictor("rc-bidaf")
    ...
    def test_semantic_role_labeling(self):
        predictor = pretrained.get_predictor("sp-srl-bert")
    ...
    def test_textual_entailment(self):
        predictor = pretrained.get_predictor("pc-decomposable-attention-elmo")
    ...
    def test_coreference_resolution(self):
        predictor = pretrained.get_predictor("coref-spanbert")
    ...
    def test_ner(self):
        predictor = pretrained.get_predictor("tagging-elmo-crf-tagger")
    ...
    def test_constituency_parsing(self):
        predictor = pretrained.get_predictor("sp-constituency-parser")
    ...
    def test_dependency_parsing(self):
        predictor = pretrained.get_predictor("sp-biaffine-parser")
    ...
    def test_openie(self):
        predictor = pretrained.get_predictor("sp-srl")
        result = predictor.predict_json(
    ...
    def test_fine_grained_ner(self, get_model_arg):
        predictor = pretrained.get_predictor(get_model_arg)

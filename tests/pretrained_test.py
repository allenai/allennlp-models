...
class TestAllenNlpPretrained(AllenNlpTestCase):
    ...
    def test_machine_comprehension(self):
        predictor = self.pretrained_models["rc-bidaf"].load_predictor()
    ...
    def test_semantic_role_labeling(self):
        predictor = self.pretrained_models["structured-prediction-srl-bert"].load_predictor()
    ...
    def test_textual_entailment(self):
        predictor = self.pretrained_models[
    ...
    def test_coreference_resolution(self):
        predictor = self.pretrained_models["coref-spanbert"].load_predictor()
    ...
    def test_ner(self):
        predictor = self.pretrained_models["tagging-elmo-crf-tagger"].load_predictor()
    ...
    def test_constituency_parsing(self):
        predictor = self.pretrained_models[
            "structured-prediction-constituency-parser"
        ].load_predictor()
    ...
    def test_dependency_parsing(self):
        predictor = self.pretrained_models["structured-prediction-biaffine-parser"].load_predictor()
    ...
    def test_openie(self):
        predictor = self.pretrained_models["structured-prediction-srl"].load_predictor()
        result = predictor.predict_json(
    ...
    def test_fine_grained_ner(self, get_model_arg):
        predictor = self.pretrained_models[get_model_arg].load_predictor()

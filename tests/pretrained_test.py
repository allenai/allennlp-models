...
class TestAllenNlpPretrained(AllenNlpTestCase):
    ...
    def test_semantic_role_labeling(self):
        predictor = pretrained.bert_srl_shi_2019()
    ...
    def test_coreference_resolution(self):
        predictor = pretrained.neural_coreference_resolution()
    ...
    def test_dependency_parsing(self):
        predictor = pretrained.biaffine_parser_universal_dependencies_todzat_2017()

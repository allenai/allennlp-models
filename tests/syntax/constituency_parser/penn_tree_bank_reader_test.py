...
from allennlp_models.syntax.constituency_parser.penn_tree_bank import PennTreeBankConstituencySpanDatasetReader
...
class TestPennTreeBankConstituencySpanReader(AllenNlpTestCase):
    ...
    def test_read_from_file(self):
        ...
        instances = ptb_reader.read(str(FIXTURES_ROOT / "syntax" / "example_ptb.trees"))

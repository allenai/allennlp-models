...
from allennlp_models.seq2seq import Seq2SeqDatasetReader
...
class TestSeq2SeqDatasetReader:
    ...
    def test_default_format(self, lazy):
        ...
        instances = reader.read(str(FIXTURES_ROOT / "seq2seq" / "seq2seq_copy.tsv"))
    ...
    def test_delimiter_parameter(self):
        ...
        instances = reader.read(str(FIXTURES_ROOT / "seq2seq" / "seq2seq_copy.csv"))
        instances = ensure_list(instances)

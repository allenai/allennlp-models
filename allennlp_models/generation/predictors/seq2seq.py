...
class Seq2SeqPredictor(Predictor):
    ...
    - [`CopyNetSeq2Seq`](../models/copynet_seq2seq.md), and
    - [`Bart`](../models/bart.md).
    """
    ...
    @classmethod
    def pretrained_bart_for_generation(
        ...
        predictor = Seq2SeqPredictor.pretrained_bart_for_generation()
        ...
        model = Bart(model_name, vocab, indexer=token_indexer)
        return Seq2SeqPredictor(model, reader)

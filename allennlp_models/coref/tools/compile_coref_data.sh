...
cat conll-2012/v3/scripts/skeleton2conll.sh | sed -e "s/python/python2/" > conll-2012/v3/scripts/skeleton2conll-python2.sh
bash conll-2012/v3/scripts/skeleton2conll-python2.sh -D $ONTONOTES_PATH/data/files/data conll-2012
